...
module ActiveRecord
  class Base
    ...
    def self.with_properties table
    ...
    def self.define_save_properties(properties)
      class_eval %{
        def save_properties
    ...
    def self.define_getters_and_setters(properties)
    ...
    def self.override_create(properties)
      instance_eval %{
